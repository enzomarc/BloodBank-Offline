...
namespace BB_App.Core.Models
{
    public class BloodPurchase
    {
        ...
        public static void PurchaseBlood(string bloodGroup, DateTime date, int units, int price)
        {
            ...
            const string query =
                "INSERT INTO purchases (ref_hospital, bloodgroup, date, units, price) VALUES (@ref, @bg, @dt, @un, @pr);";
        ...
        public static DataSet LoadReports()
        {
            ...
            var query = "SELECT id, bloodgroup, date, units, price FROM purchases WHERE ref_hospital = '" +
                        Consts.Hospital + "'";
