...
{
    partial class Purchases_Report_Form
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Purchases_Report_Form));
			...
			this.label1.Text = "Blood Purchase Report";
			...
			this.menuButton.MouseLeave += new System.EventHandler(this.menuButton_MouseEnter);
			// 
			// closeButton
			// 
			...
			this.logo.Location = new System.Drawing.Point(296, 79);
			this.logo.Name = "logo";
			...
			this.reportDGV.Location = new System.Drawing.Point(16, 137);
			...
			this.reportDGV.RowsDefaultCellStyle = dataGridViewCellStyle2;
			...
			this.addButton.Location = new System.Drawing.Point(672, 567);
			...
			this.addButton.Text = "Print Report";
			...
			this.Name = "Purchases_Report_Form";
			this.Size = new System.Drawing.Size(813, 646);
			this.Load += new System.EventHandler(this.Purchases_Report_Form_Load);
